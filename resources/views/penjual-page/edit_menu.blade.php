...
<head>
  ...
  <title>Kebab Bang Aji | Tambah Menu</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('penjual.kelolaMenu') }}" class="nav-link active" >
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Form Edit Menu</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            ...
            @endif --}}
                ...
                <!-- form start -->
                <form action="{{ route('penjual.updateMenu',['id'=> $dataMenu->id_menu])}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                @method('PUT')
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="frmNamaMenu" value="{{ $dataMenu->nama_menu }}" class="form-control @error('frmNamaMenu')is-invalid @enderror" id="" placeholder="Nama menu">
                        @error('frmNamaMenu')
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label">Deskripsi Menu</label>
                        <div class="col-sm-10">
                          <textarea name="frmDeskripsi" rows="5" class="form-control @error('frmDeskripsi')is-invalid @enderror" id="" placeholder="Deskripsi Menu">{{ $dataMenu->deskripsi_menu }}</textarea>
                          @error('frmDeskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    @if ($dataMenu->foto_menu)
                    <div class="form-group row">
                        <label for="fotoMenu" class="col-sm-2 col-form-label">Foto </label>
                        <div class="col-sm-10">
                            <img src="{{ url('foto-menu').'/'.$dataMenu->foto_menu }}" alt="" width="80px" class="rounded">
                        </div>    
                    </div>  
                    ...
                    <div class="form-group row">
                        <label for="fotoMenu" class="col-sm-2 col-form-label">Upload Foto Baru</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" name="frmHarga" value="{{ $dataMenu->harga_menu }}" class="form-control @error('frmHarga')is-invalid @enderror" id="hargamenu">
                          @error('frmHarga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary" onclick="return confirm('Anda yakin ingin menghubah data menu?')">Simpan</a>
                        </div>
                    </div>
