        ...
        <div class="row">
          <div class="col-12">
            ...
            @endif --}}
                ...
                <!-- form start -->
                <form action="{{ route('penjual.simpanMenu') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="" class="col-sm-2 col-form-label">Nama Menu</label>
                      <div class="col-sm-10">
                        <input type="text" name="frmNamaMenu" value="{{ old('frmNamaMenu') }}" class="form-control @error('frmNamaMenu')is-invalid @enderror" id="" placeholder="Nama menu">
                        @error('frmNamaMenu')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea name="frmDeskripsi" rows="5" class="form-control @error('frmDeskripsi')is-invalid @enderror" id="" placeholder="Deskripsi Menu">{{ old('frmDeskripsi') }}</textarea>
                          @error('frmDeskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row">
                        <label for="fotoMenu" class="col-sm-2 col-form-label">Foto Menu</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" name="frmHarga" value="{{ old('frmHarga') }}" class="form-control @error('frmHarga')is-invalid @enderror" id="hargamenu">
                          @error('frmHarga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
