  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Form Edit Penjual</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <!-- form start -->
                <form action="{{ route('penjual.updatePenjual',['id'=> $dataPenjual->id]) }}" method="POST" class="form-horizontal">
                @csrf
                @method('PUT')
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="frmUsername" value="{{ $dataPenjual->username }}" class="form-control @error('frmUsername')is-invalid @enderror" id="" placeholder="isi Username">
                        @error('frmUsername')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="frmNamaLengkap" value="{{ $dataPenjual->nama_lengkap }}" class="form-control @error('frmNamaLengkap')is-invalid @enderror" id="" placeholder="isi Nama lengkap">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="date" name="frmTglLahir" value="{{ $dataPenjual->tgl_lahir }}" class="form-control @error('frmTglLahir')is-invalid @enderror" id="">
                            @error('frmTglLahir')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <textarea name="frmAlamat" rows="5" class="form-control @error('frmAlamat')is-invalid @enderror" id="" placeholder="Alamat tinggal">{{ $dataPenjual->alamat }}</textarea>
                            @error('frmAlamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="number" name="frmnoTelepon" value="{{ old('frmnoTelepon', $dataPenjual->no_telepon )}}" class="form-control @error('frmnoTelepon')is-invalid @enderror" placeholder="contoh:08xxxxxxxxxx">
                            @error('frmnoTelepon')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <select name="frmRole" value="{{ old('frmRole') }}" class="form-control @error('frmRole')is-invalid @enderror">
                                ...
                                <option value="{{$dataPenjual->role}}" {{ $dataPenjual->role === $dataPenjual->role ? "selected":"" }}>{{$dataPenjual->role}}</option>
                            </select>
                            @error('frmRole')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary" onclick="return confirm('Anda yakin ingin mengubah data penjual?')">Simpan</a>
                            </div>
                        </div>
